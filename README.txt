...
The dashboard aims to provide an insightful breakdown of:
...
The entire dashboard is designed using a **custom background** featuring a cricket-themed design to enhance visual storytelling.
...
Additional calculated columns like `IsCentury` and `IsFifty` were derived using DAX.

🛠️ Tools Used

- **Power BI Desktop** (Data Modeling + Visualization)
- **DAX** (for calculated columns like milestones)
- **Custom Design Background** (16:9 aspect ratio)
- Optional: Excel/CSV for raw data formatting
...
4. Optional: Replace dataset with your own version to explore other players.
